...
\noindent First I want to make it abundantly clear that when I refer to myself as the `Anymouse Prophet', this is not a claim to religious authority.
...
In the interest of pedantic fairness, I do have to concede the United States is not exactly like Sodom when it was destroyed. Matt Gaetz likely would have accepted the disgustingly offensive offer of Lot's daughters.
...
As far as I can tell, Stacey Abrams is neither a socialist by any published definition nor does she claim to be one, but her incredible work in Georgia to overcome voter suppression is exactly what is required to end voter suppression and is compatible with my socialist goals.
...
Here in my home state of California, gun control advocates wanted to use the `Real ID' act to control who could buy guns or ammunition, requiring a `Real ID' for the purchase of either. Republicans claimed that violated their constitutional right to bear arms, a `Real ID' being difficult for many legal citizens to obtain. Yet at the same time, that `Real ID' is exactly what many of \emph{these same Republicans} want to require of us to be allowed to vote.
...
Donald Trump seriously tarnished the value of the Presidential Medal of Freedom when he awarded it to Limbaugh. Joe Biden can restore honor to that medal by awarding it to Stacey Abrams for her work in overcoming voter suppression, and I say that even though I am sure she and I disagree on many many many things politically.

If we can shift this nation away from partisan politics and towards politics that serve the people instead of serving the political party, then we can get at least part of the socialist agenda into law even with only a minority representation in the House of Representatives and in the Senate. Democracy is key to this happening. As socialists, we need to work towards overcoming voter suppression with any politician who is committed to doing so, whether they bear the red rose or not.
...
For those who seek religious authority, consider \rom{2} Chronicles 7:14:
